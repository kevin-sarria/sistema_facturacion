...
import { DashboardPage, Menu, Navbar, Table } from '../../'
...
export const InventarioPage = () => {
  ...
  const titulos = ['#', 'Nombre', 'Cantidad', 'Valor medida', 'Precio de compra', 'Porcentaje Ganancia', 'Precio Venta'];
  ...
  return (
    <div className='flex-1'>
      ...
      <Table data={data} titulos={titulos} />
