  ...
  return (
    <div className=''>
        ...
        <div className="text-center p-5 w-80 sm:w-96">
          ...
          <h1 className='text-6xl text-indigo-600 font-semibold uppercase mb-16'>Recuperar Cuenta</h1>
          ...
          <form className='formulario'>
            ...
            <input type="submit" value="Enviar Instrucciones" className="w-full text-xl p-3 rounded-sm bg-indigo-600 text-white hover:bg-indigo-700 cursor-pointer" />
